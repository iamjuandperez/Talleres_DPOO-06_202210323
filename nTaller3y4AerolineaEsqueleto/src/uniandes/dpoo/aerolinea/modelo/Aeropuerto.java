...
/**
 * Esta clase encapsula la información sobre los aeropuertos e implementa
 * algunas operaciones relacionadas con la ubicación geográfica de los
 * aeropuertos.
 * 
...
public class Aeropuerto {
	...
	/**
	 * Este método calcula la distancia *aproximada* entre dos aeropuertos. Hay
	 * fórmulas más precisas pero esta es suficientemente buena para el caso de la
	 * aerolínea.
	 * 
	 * Este método asume que las coordenadas (latitud y longitud) de los aeropuertos
	 * están expresadas en la forma que las hace más cercanas. Si no es así, la
	 * distancia entre los dos aeropuertos podría ser la más larga posible.
	 * 
	 * Por ejemplo, dependiendo de cómo estén expresadas las longitudes, la
	 * distancia calculada entre Narita (Tokyo) y El Dorado (Bogotá) podría ser
	 * atravesando el Pacífico, o atravesando el Atlántico y Asia (el camino largo)
	 * 
	 * @param aeropuerto1
	 * @param aeropuerto2
	...
	public static int calcularDistancia(Aeropuerto aeropuerto1, Aeropuerto aeropuerto2) {
		// Convertir los ángulos a radianes para facilitar las operaciones
		// trigonométricas
