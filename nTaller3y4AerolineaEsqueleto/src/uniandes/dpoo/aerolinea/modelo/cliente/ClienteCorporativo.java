...
public class ClienteCorporativo extends Cliente {
	// TODO completar
	public static final String CORPORTATIVO = "Corporativo";
	...
	public String getTipoCliente() {
		...
		return ClienteCorporativo.CORPORTATIVO;
	 ...
	 * 
	 * El objeto JSON debe tener dos atributos: nombreEmpresa (una cadena) y
	 * tamanoEmpresa (un número).
	 * 
	...
	public JSONObject salvarEnJSON() {
		...
		jobject.put("tipo", ClienteCorporativo.CORPORTATIVO);
		return jobject;
	}
}
